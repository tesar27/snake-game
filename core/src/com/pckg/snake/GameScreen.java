...
public class GameScreen extends ScreenAdapter {
    ...
    public void show(){
        ...
        snakeHead = new Texture(Gdx.files.internal("snake_head_s.png"));
        apple     = new Texture(Gdx.files.internal("apple_s.png"));
        snakeBody = new Texture(Gdx.files.internal("snake_body_s.png"));
    ...
    private void timerHandler(float delta){
        timer -= delta;
        if(timer <= 0) {
            timer = MOVE_TIME;
            moveSnake();
